...
const lang = {
    idn: {
        ...
        facilitys: {
            card: ['Warung Wisata', 'Spot Foto', 'Musholla', 'Toilet', 'Souvenir', 'Area Parkir', 'Area Camping', 'Sewa Kuda', 'Penjual Kelinci', 'Playground', 'Motor ATV'],
        },
    ...
    eng: {
        ...
        facilitys: {
            card: ['Restaurant', 'Photography', 'Shrine', 'Toilet', 'Souvenir', 'Parking Area', 'Camping Area', 'Horse Rental', 'Rabbit Seller', 'Playground', 'Motor ATV']
        },
